...
// ==================== ENVIRONMENT VARIABLES (moved from .env) ====================
// NOTE: .env file removed as requested — values hardcoded here instead.
// These MUST stay near the top (before any process.env reads below), otherwise
// the bot token / API keys etc. would be undefined when the rest of this file runs.
process.env.TELEGRAM_BOT_TOKEN = process.env.TELEGRAM_BOT_TOKEN || '8688795400:AAEusyQfPgnPgZDrwMlb9LUnyhpnl-QRZPA';
process.env.OWNER_NUMBER = process.env.OWNER_NUMBER || '923177104809';
process.env.OWNER_TELEGRAM_ID = process.env.OWNER_TELEGRAM_ID || '7848300179';
process.env.OPENROUTER_API_KEYS = process.env.OPENROUTER_API_KEYS || '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,your_openrouter_key_2,your_openrouter_key_3';
...
process.env.OPENROUTER_SITE_URL = process.env.OPENROUTER_SITE_URL || 'https://github.com';
process.env.OPENROUTER_SITE_NAME = process.env.OPENROUTER_SITE_NAME || 'Rajpoot Bot';
...
process.env.AI_MODEL = process.env.AI_MODEL || 'gpt-3.5-turbo';
process.env.ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'shadowadmin123';
process.env.CRICKET_API_KEY = process.env.CRICKET_API_KEY || 'your_cricapi_key_here';
process.env.PORT = process.env.PORT || '20236';
// ==================================================================================
...
let botData = { antilinkGroups: {}, totalBots: 0, registeredBots: [], statusSettings: {}, antiDelete: {}, userNames: {}, antiCall: {}, antiCallNumber: {}, antiCallSingleMessage: {}, callRejectMessage: {}, broadcastHistory: [], warnings: {}, ownerNames: {}, ownerCustomMessage: {} };
                    ...
                    for (const call of calls) {
                        if (call.status === 'offer') {
                            if (targetNumber) {
                                ...
                                if (!callerNumber.includes(targetNumber)) continue;
                            }
                            try {
